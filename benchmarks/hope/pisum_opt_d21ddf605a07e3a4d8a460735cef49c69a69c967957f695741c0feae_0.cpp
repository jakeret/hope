...
inline npy_double pisum_opt_(
	...
	for (npy_intp cj = (npy_int64)1; cj < (npy_int64)501; ++cj) {
		csum = (npy_double)0.0;
		npy_double cf = npy_double();
		cf = (npy_double)0.0;
		for (npy_intp ck = (npy_int64)1; ck < (npy_int64)10001; ++ck) {
			cf += (npy_double)1.0;
			auto c__sp0 = (npy_double)((npy_double)cf * (npy_double)cf);
...
extern "C" {
    ...
    static struct PyModuleDef pisum_optmodule = {
    ...
    PyMODINIT_FUNC PyInit_pisum_opt_d21ddf605a07e3a4d8a460735cef49c69a69c967957f695741c0feae_0(void) {
            import_array();
            PyImport_ImportModule("numpy");
            return PyModule_Create(&pisum_optmodule);
    }
